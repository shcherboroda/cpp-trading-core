...
- Added a controlled virtual-time Bybit L2 burst-arrival replay. It measures bounded decode+apply service time and models a single-server queue without `sleep` or network timing. Seven CPU-0 runs show no burst-to-burst spillover at p99 for 8/16-frame bursts separated by 1 ms or 100 us, while 8/16-frame bursts every 10 us have median burst-start p99 of 722.505 us/9.339 ms. This is an admission test for a future SPSC variant, not a claim about real exchange arrival latency. Raw CSV: `results/bybit-l2-arrival-replay-20260816T092345Z/raw.csv`.
