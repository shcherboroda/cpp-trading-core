...
- Post-merge replication on the final `main` confirms both decisions. Seven paced depth-50 runs per parser variant show one-pass p50/p99 8.892/26.134 microseconds versus bounded 8.790/22.848, so it remains experimental. Seven depth-1,000 resnapshot runs per variant show map reconciliation p50/p99 17.869/28.244 microseconds versus clear-and-build 125.758/200.056, confirming the accepted snapshot improvement. Raw evidence: `results/bybit-l2-paced-abba-main-20260816T122947382496280Z/` and `results/bybit-l2-resnapshot-20260816T123210375156557Z/`.
